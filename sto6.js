...
if (!fs.existsSync('uploadshh')) {
    fs.mkdirSync('uploadshh');
}
...
// Serve the HTML file
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'sto6.html'));
});
...
app.put('/api/upload', (req, res) => {
    ...
    const filePath = path.join(__dirname, 'uploadshh', `${STREAM_NAME}_chunk_${CHUNK_NUMBER}.webm`);
